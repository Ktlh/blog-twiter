            ...
            <div class="inner">
                ...
                <article class="box post post-excerpt">
                    ...
                    <c:if test="${ac == true}">
                        ...
                        <%--</form>--%>
                    <button id="DeleteButton" value="Delete post" onclick="DeletePost(${p.id})"></button>
                    </c:if>
            ...
            <section class="box text-style1">
                <div class="inner">
                    <p>
                        ...
                        template designed by <a href="http://n33.co/">AJ</a> for <a href="http://html5up.net/">HTML5
                        UP</a>
                    </p>
                </div>
            </section>
